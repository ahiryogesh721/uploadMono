    ...
    <div className="">
      <div className="p-10 flex flex-col gap-1">
        ...
        <p className="text-yellow-600">
          2:this website is only publicly avalible for short term after then it
          will be subscribtion based service
        </p>
        ...
        <p className="text-gray-400">
          5:last 3 charts for players who plays on odds of 2, 3 and 5
        </p>
        <p className="text-gray-400">
          6:for contact DM me on instagram:
          <a
